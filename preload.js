...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  getAllSystemSettings: () => ipcRenderer.invoke('get-all-system-settings'),
  saveSettingsToFile: (data) => ipcRenderer.invoke('save-settings-to-file', data),
  loadSettingsFromFile: () => ipcRenderer.invoke('load-settings-from-file'),
  importSystemSettings: (settings) => ipcRenderer.invoke('import-system-settings', settings),
